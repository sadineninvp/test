"""
Web Tools Node - Executes web-related tools
"""

from typing import Dict, Any
from ...graph.state import AgentState
from ...tools.tool_registry import get_web_tools
from langchain_core.messages import ToolMessage


def web_tools_node(state: AgentState) -> AgentState:
    """
    ...
    # Get web tools
    web_tools = {tool.name: tool for tool in get_web_tools()}
    ...
    for tool_call in tool_calls:
        ...
        if tool_name in web_tools:
            try:
                # Execute tool
                result = web_tools[tool_name].invoke(tool_args)
